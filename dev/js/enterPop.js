...
enterPopTL.fromTo("#rocket-pop", {duration:1, alpha:0, y:"+=125"}, {duration:1, alpha:1, y:"-=450"})
            ...
            .to(".rocket-lines-b", {duration:0.25, alpha:0.5, rotate: 5, repeat:9, yoyo:true})
            .to(".rocket-lines-r", {duration:0.25, alpha:0.5, rotate: 5, repeat:5, yoyo:true}, "-=1.5")
            .to(".rocket-lines-w", {duration:0.25, alpha:0.5, rotate: -5, repeat:9, yoyo:true}, "-=1.75");